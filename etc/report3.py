...
class report3:
    def report3(self, year):
        # csv를 데이터프레임으로 저장하기
        self.df_hyen = pd.read_csv('D:/report_csv/report/'+year+'_3_hyen.csv', encoding='cp949')
        self.df_hyen_y = pd.read_csv('D:/report_csv/report/'+year+'_3_hyen_y.csv', encoding='cp949')
        self.df_jaemu = pd.read_csv('D:/report_csv/report/'+year+'_3_jaemu.csv', encoding='cp949')
        self.df_jaemu_y = pd.read_csv('D:/report_csv/report/'+year+'_3_jaemu_y.csv', encoding='cp949')
        self.df_posonik = pd.read_csv('D:/report_csv/report/'+year+'_3_posonik.csv', encoding='cp949')
        self.df_posonik_y = pd.read_csv('D:/report_csv/report/'+year+'_3_posonik_y.csv', encoding='cp949')
        
        # 데이터 정제하기(필요없는 열 제거하기)
        self.df_hyen = self.df_hyen.drop(['재무제표종류','시장구분','결산월','결산기준일','보고서종류','통화', '전기 3분기', '전기', '전전기'], axis=1)
        self.df_hyen_y = self.df_hyen_y.drop(['재무제표종류','시장구분','결산월','결산기준일','보고서종류','통화', '전기 3분기', '전기','전전기'], axis=1)
        ...
        self.df_posonik = self.df_posonik.drop(['재무제표종류','시장구분','결산월','결산기준일','보고서종류','통화', '당기 3분기 누적', '전기 3분기 3개월', '전기 3분기 누적', '전기', '전전기'], axis=1)
        self.df_posonik_y= self.df_posonik_y.drop(['재무제표종류','시장구분','결산월','결산기준일','보고서종류','통화', '당기 3분기 누적', '전기 3분기 3개월', '전기 3분기 누적', '전기', '전전기'], axis=1)
        ...
        hyen1.rename(columns={'당기 3분기':'영업현금흐름_당기3분기'}, inplace=True)
        ...
        hyen2.rename(columns={'당기 3분기':'투자현금흐름_당기3분기'}, inplace=True)
        ...
        hyen3.rename(columns={'당기 3분기':'재무현금흐름_당기3분기'}, inplace=True)
        ...
        hyen1_y.rename(columns={'당기 3분기':'영업현금흐름_당기3분기_연결'}, inplace=True)
        ...
        hyen2_y.rename(columns={'당기 3분기':'투자현금흐름_당기3분기_연결'}, inplace=True)
        ...
        hyen3_y.rename(columns={'당기 3분기':'재무현금흐름_당기3분기_연결'}, inplace=True)
        ...
        jaemu1_y.rename(columns={'당기 3분기말':'유동자산_당기3분기말_연결'}, inplace=True)
        ...
        jaemu2_y.rename(columns={'당기 3분기말':'비유동자산_당기3분기말_연결'}, inplace=True)
        
        jaemu3_y = self.df_jaemu_y[self.df_jaemu_y['항목코드'].isin(['ifrs-full_Assets'])]
        jaemu3_y = jaemu3_y.drop(['회사명','업종','업종명','항목명','항목코드'], axis=1)
        jaemu3_y.rename(columns={'당기 3분기말':'자산총계_당기3분기말_연결'}, inplace=True)
        ...
        jaemu4_y.rename(columns={'당기 3분기말':'유동부채_당기3분기말_연결'}, inplace=True)
        ...
        jaemu5_y.rename(columns={'당기 3분기말':'비유동부채_당기3분기말_연결'}, inplace=True)
        ...
        jaemu6_y.rename(columns={'당기 3분기말':'부채총계_당기3분기말_연결'}, inplace=True)
        ...
        jaemu7_y.rename(columns={'당기 3분기말':'자본금_당기3분기말_연결'}, inplace=True)
        ...
        jaemu8_y.rename(columns={'당기 3분기말':'이익잉여금_당기3분기말_연결'}, inplace=True)
        
        jaemu9_y = self.df_jaemu_y[self.df_jaemu_y['항목코드'].isin(['ifrs-full_Equity'])]
        jaemu9_y = jaemu9_y.drop(['회사명','업종','업종명','항목명','항목코드'], axis=1)
        jaemu9_y.rename(columns={'당기 3분기말':'자본총계_당기3분기말_연결'}, inplace=True)
        ...
        posonik1.rename(columns={'당기 3분기 3개월':'(포)매출액_당기3분기3개월'}, inplace=True)
        ...
        posonik2.rename(columns={'당기 3분기 3개월':'(포)매출원가_당기3분기3개월'}, inplace=True)
        ...
        posonik3.rename(columns={'당기 3분기 3개월':'(포)매출총이익_당기3분기3개월'}, inplace=True)
        ...
        posonik4.rename(columns={'당기 3분기 3개월':'(포)판관비_당기3분기3개월'}, inplace=True)
        ...
        posonik5.rename(columns={'당기 3분기 3개월':'(포)영업이익_당기3분기3개월'}, inplace=True)
        ...
        posonik6.rename(columns={'당기 3분기 3개월':'(포)법인세비용차감전순이익_당기3분기3개월'}, inplace=True)
        
        posonik7 = self.df_posonik[self.df_posonik['항목코드'].isin(['ifrs-full_ProfitLoss'])]
        posonik7 = posonik7.drop(['회사명','업종','업종명','항목명','항목코드'], axis=1)
        posonik7.rename(columns={'당기 3분기 3개월':'(포)당기순이익_당기3분기3개월'}, inplace=True)
        ...
        posonik8.rename(columns={'당기 3분기 3개월':'(포)총포괄손익_당기3분기3개월'}, inplace=True)
        ...
        posonik1_y.rename(columns={'당기 3분기 3개월':'(포)매출액_당기3분기3개월_연결'}, inplace=True)
        ...
        posonik2_y.rename(columns={'당기 3분기 3개월':'(포)매출원가_당기3분기3개월_연결'}, inplace=True)
        ...
        posonik3_y.rename(columns={'당기 3분기 3개월':'(포)매출총이익_당기3분기3개월_연결'}, inplace=True)
        ...
        posonik4_y.rename(columns={'당기 3분기 3개월':'(포)판관비_당기3분기3개월_연결'}, inplace=True)
        ...
        posonik5_y.rename(columns={'당기 3분기 3개월':'(포)영업이익_당기3분기3개월_연결'}, inplace=True)
        ...
        posonik6_y.rename(columns={'당기 3분기 3개월':'(포)법인세비용차감전순이익_당기3분기3개월_연결'}, inplace=True)
        ...
        posonik7_y.rename(columns={'당기 3분기 3개월':'(포)당기순이익_당기3분기3개월_연결'}, inplace=True)
        ...
        posonik8_y.rename(columns={'당기 3분기 3개월':'(포)총포괄손익_당기3분기3개월_연결'}, inplace=True)
